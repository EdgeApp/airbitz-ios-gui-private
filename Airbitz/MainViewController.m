...
- (void)viewDidLoad
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(handleBitcoinUri:) name:ABC_NOTIFICATION_HANDLE_BITCOIN_URI object:nil];
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(loggedOffRedirect:) name:ABC_NOTIFICATION_LOGOUT_ACCOUT object:nil];
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(launchViewSweep:) name:ABC_NOTIFICATION_VIEW_SWEEP_TX object:nil];
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(lockTabbar) name:ABC_NOTIFICATION_WALLETS_LOADING object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(unlockTabbar) name:ABC_NOTIFICATION_WALLETS_LOADED object:nil];
