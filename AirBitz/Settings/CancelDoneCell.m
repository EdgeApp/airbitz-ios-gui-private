...
-(void)awakeFromNib
{
	...
	[self.cancelButton setTitle:[Theme Singleton].cancelButtonText forState:UIControlStateNormal];
	[self.doneButton setTitle:[Theme Singleton].doneButtonText forState:UIControlStateNormal];
}
