...
- (id)init
{
    ...
    self.OfflineWalletText                              = NSLocalizedString(@"Offline Wallet", nil);
    self.PublickeyCopiedText                            = NSLocalizedString(@"Public Key copied to clipboard", nil);
    self.ExportWalletText                               = NSLocalizedString(@"Wallet Export", nil);
    self.ExportWalletTransactions                       = NSLocalizedString(@"Export Wallet Transactions", nil);
    self.AirprintIsNotAvailableText                     = NSLocalizedString(@"AirPrint is not currently available", nil);
    self.AirbitzWalletTransactions                      = NSLocalizedString(@"AirBitz Bitcoin Wallet Transactions", nil);
    self.EmailNotSent                                   = NSLocalizedString(@"Can't send e-mail", nil);
    self.NoTransactionsText                             = NSLocalizedString(@"No Transactions in Wallet", nil);
    self.ExportWalletTransactionsError                  = NSLocalizedString(@"Export Wallet Transactions error", nil);
    self.CSVExportFailed                                = NSLocalizedString(@"CSV Export failed", nil);
    self.AccountAlreadyExistsText                       = NSLocalizedString(@"This account already exists.", nil);
    self.AccountDoesNotExistText                        = NSLocalizedString(@"We were unable to find your account. Be sure your username is correct.", nil);
    self.InvalidPasswordOrUsernameText                  = NSLocalizedString(@"Invalid user name or password", nil);
    self.WalletAlreadyExistsText                        = NSLocalizedString(@"Wallet already exists.", nil);
    self.InvalidWalletIdText                            = NSLocalizedString(@"Wallet does not exist.", nil);
    self.ServerErrorForAirbitzText                      = NSLocalizedString(@"Unable to connect to Airbitz server. Please try again later.", nil);
    self.NoRecoveryQuestionsText                        = NSLocalizedString(@"No recovery questions are available for this user", nil);
    self.NotSupportedText                               = NSLocalizedString(@"This operation is not supported.", nil);
    self.InsufficientFundsText                          = NSLocalizedString(@"Insufficient funds", nil);
    self.SynchronizingNetworkText                       = NSLocalizedString(@"Synchronizing with the network.", nil);
    self.NonNumericPinText                              = NSLocalizedString(@"PIN must be a numeric value.", nil);
    self.FailedLoginAttemptsText                        = NSLocalizedString(@"Too many failed login attempts. Please try again in %@ seconds.", nil);
    self.AnErrorOccurredText                            = NSLocalizedString(@"An error has occurred.", nil);
    self.ExpenseText                                    = NSLocalizedString(@"Expense", nil);
